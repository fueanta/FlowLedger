...
namespace FlowLedger.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260613124839_AddTemporalHistoryTables")]
    partial class AddTemporalHistoryTables
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("FlowLedger.Domain.Entities.AppSetting", b =>
                {
                    ...
                    b.ToTable(tb => tb.IsTemporal(ttb =>
                            {
                                ttb.UseHistoryTable("AppSettingsHistory");
                                ttb
            ...
            modelBuilder.Entity("FlowLedger.Domain.Entities.BillingRequest", b =>
                {
                    ...
                    b.ToTable(tb => tb.IsTemporal(ttb =>
                            {
                                ttb.UseHistoryTable("BillingRequestsHistory");
                                ttb
                                    .HasPeriodStart("ValidFrom")
                                    .HasColumnName("ValidFrom");
                                ttb
